variable		input_file string Graphene_water
...
write_data      ${input_file}_freeze.data
...
# Bond Length
compute         1 G_Polymer property/local batom1 batom2 btype
compute         2 G_Polymer bond/local engpot dist
dump            2 G_Polymer local ${freq} ./dump/dump.* c_1[*] c_2[*]

run				1000000 # 1 ns
write_data      ${input_file}_end.data